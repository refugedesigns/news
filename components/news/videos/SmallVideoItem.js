...
const SmallVideoItem = () => {
    return (
      <div className="flex justify-center ">
        <div className="w-44 border-b py-4 lg:py-0 lg:border-none">
          <div className="relative">
            <Image
              ...
              height={100}
            />
            <PlayIcon className="h-8 absolute bottom-0 text-white bg-green-500 px-1" />
          </div>
          <div>
            <h1 className="text-sm font-semibold text-green-100">
              Iran Intelligence Agency to Trace Illegal Crypto Mining Activities
            </h1>
            <p className="text-sm font-semibold text-green-300">04m 22s</p>
          </div>
        </div>
      </div>
    );
